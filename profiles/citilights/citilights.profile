 ...
 */
function citilights_form_install_configure_form_alter(&$form, $form_state) {
  // Pre-populate the site name with the server name.
  $form['site_information']['site_name']['#default_value'] = $_SERVER['SERVER_NAME'];
  $form['#submit'][] = 'citilights_form_submit';
}


function citilights_form_submit($form, &$form_state) {
  // Import database citilights file.
  $citilights_file = dirname(__FILE__) . '/citilights.sql';
  $success = import_citilights($citilights_file);
 ...
 * @see demo_reset().
 */
function import_citilights($filename) {
