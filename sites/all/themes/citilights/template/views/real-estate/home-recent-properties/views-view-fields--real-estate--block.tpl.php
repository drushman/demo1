<article class="hentry has-featured">
  <div class="property-featured">
    <a class="content-thumb" href="<?php print $fields['path']->content; ?>">
      <img src="<?php print image_style_url('home_recent_properties', $fields['field_real_thumbnail']->content); ?>" class="attachment-property-thumb" alt="" />
    </a>
    <span class="property-category">
      <?php print $fields['field_real_type']->content; ?>
    </span>
